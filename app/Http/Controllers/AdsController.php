...
class AdsController extends Controller
{
    ...
    function updatePopAd(Request $request)
    {
      ...
      return back()->with('success','Popup Ad Setting Updated !');
    }
    ...
    function delete($id)
    {
      ...
      elseif($ad->ad_type == "video")
      {
        ...
        return back()->with('delete','Ad Deleted Successfully !');
    }
    ...
    public function bulk_delete(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return back()->with('delete', 'Please select one of them to delete');
        }
        ...
        return back()->with('delete', 'Ads has been deleted');
    }
}
