      ...
      <?php if(Auth::User()->role == "admin"): ?>
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="<?php echo e(Nav::isRoute('all.instructor')); ?> <?php echo e(Nav::isResource('requestinstructor')); ?> treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Nav::isRoute('all.instructor')); ?>"><a href="<?php echo e(route('all.instructor')); ?>"><?php echo e(__('adminstaticword.AllInstructor')); ?></a></li>
              <li class="<?php echo e(Nav::isResource('requestinstructor')); ?>"><a href="<?php echo e(url('requestinstructor')); ?>"><?php echo e(__('adminstaticword.InstructorRequest')); ?></a></li>
            </ul>
          </li>
          ...
          <li class="<?php echo e(Nav::isResource('category')); ?> <?php echo e(Nav::isResource('subcategory')); ?> <?php echo e(Nav::isResource('childcategory')); ?> <?php echo e(Nav::isResource('course')); ?> <?php echo e(Nav::isResource('courselang')); ?> treeview">
            ...
            <ul class="treeview-menu">
                <li class="<?php echo e(Nav::isResource('category')); ?> <?php echo e(Nav::isResource('subcategory')); ?> <?php echo e(Nav::isResource('childcategory')); ?> <?php echo e(Nav::isResource('course')); ?> <?php echo e(Nav::isResource('courselang')); ?> <?php echo e(Nav::isResource('coursereview')); ?> treeview">
                    ...
                    <ul class="treeview-menu">
                      <li class="<?php echo e(Nav::isResource('category')); ?>"><a href="<?php echo e(url('category')); ?>"><?php echo e(__('adminstaticword.Category')); ?></a></li>
                      <li class="<?php echo e(Nav::isResource('subcategory')); ?>"><a href="<?php echo e(url('subcategory')); ?>"><?php echo e(__('adminstaticword.SubCategory')); ?></a></li>
                      <li class="<?php echo e(Nav::isResource('childcategory')); ?>"><a href="<?php echo e(url('childcategory')); ?>"><?php echo e(__('adminstaticword.ChildCategory')); ?></a></li>
                    </ul>
          ...
          <li class="<?php echo e(Nav::isResource('admin/country')); ?> <?php echo e(Nav::isResource('admin/state')); ?> <?php echo e(Nav::isResource('admin/city')); ?> treeview">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Nav::isResource('admin/country')); ?>"><a href="<?php echo e(url('admin/country')); ?>"><?php echo e(__('adminstaticword.Country')); ?></a></li>
              <li class="<?php echo e(Nav::isResource('admin/state')); ?>"><a href="<?php echo e(url('admin/state')); ?>"><?php echo e(__('adminstaticword.State')); ?></a></li>
              <li class="<?php echo e(Nav::isResource('admin/city')); ?>"><a href="<?php echo e(url('admin/city')); ?>"><?php echo e(__('adminstaticword.City')); ?></a></li>
            </ul>
          </li>
          ...
          <li class="<?php echo e(Nav::isResource('faq')); ?> <?php echo e(Nav::isResource('faqinstructor')); ?>  treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Nav::isResource('faq')); ?>"><a href="<?php echo e(url('faq')); ?>"><?php echo e(__('adminstaticword.FaqStudent')); ?></a></li>
              <li class="<?php echo e(Nav::isResource('faqinstructor')); ?>"><a href="<?php echo e(url('faqinstructor')); ?>"><?php echo e(__('adminstaticword.FaqInstructor')); ?></a></li>
            </ul>
          </li>
          ...
          <li class="<?php echo e(Nav::isRoute('instructor.settings')); ?> <?php echo e(Nav::isRoute('admin.instructor')); ?> <?php echo e(Nav::isRoute('admin.completed')); ?>  treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Nav::isRoute('instructor.settings')); ?>"><a href="<?php echo e(route('instructor.settings')); ?>"><?php echo e(__('adminstaticword.PayoutSettings')); ?></a></li>
              <li class="<?php echo e(Nav::isRoute('admin.instructor')); ?>"><a href="<?php echo e(route('admin.instructor')); ?>"><?php echo e(__('adminstaticword.PendingPayout')); ?></a></li>

              <li class="<?php echo e(Nav::isRoute('admin.completed')); ?>"><a href="<?php echo e(route('admin.completed')); ?>"><?php echo e(__('adminstaticword.CompletedPayout')); ?></a></li>
          ...
          <li class="<?php echo e(Nav::isResource('user/course/report')); ?>  treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Nav::isResource('user/course/report')); ?>"><a href="<?php echo e(url('user/course/report')); ?>"><span><?php echo e(__('adminstaticword.Report')); ?> Course</span></a></li>
              <li class="<?php echo e(Nav::isResource('user/question/report')); ?>"><a href="<?php echo e(url('user/question/report')); ?>"><span><?php echo e(__('adminstaticword.Report')); ?> Question</span></a></li>
            </ul>
          </li>
          ...
          <li class="<?php echo e(Nav::isResource('slider')); ?> <?php echo e(Nav::isResource('facts')); ?> <?php echo e(Nav::isRoute('category.slider')); ?> <?php echo e(Nav::isResource('coursetext')); ?> <?php echo e(Nav::isResource('getstarted')); ?> <?php echo e(Nav::isResource('trusted')); ?> <?php echo e(Nav::isRoute('widget.setting')); ?> <?php echo e(Nav::isRoute('terms')); ?> <?php echo e(Nav::isResource('testimonial')); ?> treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Nav::isResource('slider')); ?>"><a href="<?php echo e(url('slider')); ?>"><span><?php echo e(__('adminstaticword.Slider')); ?></span></a></li>
              <li class="<?php echo e(Nav::isResource('facts')); ?>"><a href="<?php echo e(url('facts')); ?>"><span><?php echo e(__('adminstaticword.FactsSlider')); ?></span></a></li>
              <li class="<?php echo e(Nav::isRoute('category.slider')); ?>"><a href="<?php echo e(route('category.slider')); ?>"><span><?php echo e(__('adminstaticword.CategorySlider')); ?></span></a></li>
              <li class="<?php echo e(Nav::isResource('coursetext')); ?>"><a href="<?php echo e(url('coursetext')); ?>"> <?php echo e(__('adminstaticword.CourseText')); ?></a></li>
              <li class="<?php echo e(Nav::isResource('getstarted')); ?>"><a href="<?php echo e(url('getstarted')); ?>"><?php echo e(__('adminstaticword.GetStarted')); ?></a></li>
              <li class="<?php echo e(Nav::isResource('trusted')); ?>"><a href="<?php echo e(url('trusted')); ?>"><span><?php echo e(__('adminstaticword.TrustedSlider')); ?></span></a></li>
              <li class="<?php echo e(Nav::isRoute('widget.setting')); ?>"><a href="<?php echo e(route('widget.setting')); ?>"><?php echo e(__('adminstaticword.WidgetSetting')); ?></a></li>
              <li class="<?php echo e(Nav::isResource('testimonial')); ?>"><a href="<?php echo e(url('testimonial')); ?>"><?php echo e(__('adminstaticword.Testimonial')); ?></a></li>
            </ul>
          </li>
          ...
          <li class="<?php echo e(Nav::isRoute('gen.set')); ?> <?php echo e(Nav::isRoute('api.setApiView')); ?> <?php echo e(Nav::isResource('blog')); ?> <?php echo e(Nav::isRoute('about.page')); ?> <?php echo e(Nav::isRoute('careers.page')); ?> <?php echo e(Nav::isRoute('comingsoon.page')); ?> <?php echo e(Nav::isRoute('termscondition')); ?> <?php echo e(Nav::isRoute('policy')); ?> <?php echo e(Nav::isRoute('bank.transfer')); ?> <?php echo e(Nav::isRoute('show.pwa')); ?> treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="<?php echo e(Nav::isRoute('gen.set')); ?>"><a href="<?php echo e(route('gen.set')); ?>"><span><?php echo e(__('adminstaticword.Setting')); ?></span></a></li>
              <li class="<?php echo e(Nav::isRoute('api.setApiView')); ?>"><a href="<?php echo e(route('api.setApiView')); ?>"><?php echo e(__('adminstaticword.APISetting')); ?></a></li>
              
              <li class="<?php echo e(Nav::isResource('blog')); ?>"><a href="<?php echo e(url('blog')); ?>"><?php echo e(__('adminstaticword.Blog')); ?></a></li>
              <li class="<?php echo e(Nav::isRoute('about.page')); ?>"><a href="<?php echo e(route('about.page')); ?>"><?php echo e(__('adminstaticword.About')); ?></a></li>
              <li class="<?php echo e(Nav::isRoute('comingsoon.page')); ?>"><a href="<?php echo e(route('comingsoon.page')); ?>"><?php echo e(__('adminstaticword.ComingSoon')); ?></a></li>
              <li class="<?php echo e(Nav::isRoute('termscondition')); ?>"><a href="<?php echo e(route('termscondition')); ?>"><?php echo e(__('adminstaticword.Terms&Condition')); ?> </a></li>
              <li class="<?php echo e(Nav::isRoute('policy')); ?>"><a href="<?php echo e(route('policy')); ?>"> <?php echo e(__('adminstaticword.PrivacyPolicy')); ?></a></li>
              ...
              <li class="<?php echo e(Nav::isRoute('meeting.create')); ?> <?php echo e(Nav::isRoute('zoom.show')); ?> <?php echo e(Nav::isRoute('zoom.edit')); ?> <?php echo e(Nav::isRoute('zoom.setting')); ?> <?php echo e(Nav::isRoute('zoom.index')); ?>  treeview">
                ...
                <ul class="treeview-menu">
                  <li class="<?php echo e(Nav::isRoute('zoom.setting')); ?>"><a href="<?php echo e(route('zoom.setting')); ?>"><?php echo e(__('Zoom Settings')); ?></a></li>
                  <li class="<?php echo e(Nav::isRoute('zoom.index')); ?> <?php echo e(Nav::isRoute('zoom.show')); ?> <?php echo e(Nav::isRoute('zoom.edit')); ?> <?php echo e(Nav::isRoute('meeting.create')); ?>"><a href="<?php echo e(route('zoom.index')); ?>"><?php echo e(__('Zoom Dashboard')); ?></a></li>
                  <li class="<?php echo e(Nav::isRoute('meeting.show')); ?>"><a href="<?php echo e(route('meeting.show')); ?>"><?php echo e(__('adminstaticword.AllMeetings')); ?></a></li>
                </ul>
              </li>
           <?php endif; ?>
            </ul>
...
<!--           <li class="<?php echo e(Nav::isRoute('player.set')); ?> <?php echo e(Nav::isResource('ads')); ?> <?php echo e(Nav::isResource('ad.setting')); ?> treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li class="<?php echo e(Nav::isRoute('player.set')); ?>"><a href="<?php echo e(route('player.set')); ?>"> <?php echo e(__('adminstaticword.PlayerCustomization')); ?></a></li>

              <li class="<?php echo e(Nav::isResource('ads')); ?>"><a href="<?php echo e(url('admin/ads')); ?>" title="Create ad"><?php echo e(__('adminstaticword.Advertise')); ?></a></li>
              <?php $ads = App\Ads::all(); ?>
              <?php if($ads->count()>0): ?>
              <li class="<?php echo e(Nav::isResource('ad.setting')); ?>"><a href="<?php echo e(url('admin/ads/setting')); ?>" title="Ad Settings"><?php echo e(__('adminstaticword.AdvertiseSettings')); ?></a></li>
              <?php endif; ?>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH /var/www/vhosts/edustar.academiaenvivo.com/httpdocs/new/edu-pro-new/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>