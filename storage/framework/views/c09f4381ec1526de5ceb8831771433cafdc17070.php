<?php $__env->startSection('title', 'View Subcategory - Admin'); ?>
    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><?php echo e(__('adminstaticword.SubCategory')); ?></h3>
        </div>
        <div class="box-header">
          <a class="btn btn-info btn-sm" href="<?php echo e(url('subcategory/create')); ?>">
          <i class="glyphicon glyphicon-th-"></i>+ <?php echo e(__('adminstaticword.AddSubCategory')); ?></a>
          <br>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
...
<?php echo $__env->make('admin/layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/edustar.academiaenvivo.com/httpdocs/new/edu-pro-new/resources/views/admin/category/subcategory/index.blade.php ENDPATH**/ ?>