              ...
              <form enctype="multipart/form-data" id="demo-form2" method="post" action="<?php echo e(route('courseclass.store')); ?>" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 display-none" id="videotype">
                    ...
                    <input type="radio" name="checkVideo" id="ch2" value="uploadvideo"><?php echo e(__('adminstaticword.UploadVideo')); ?>
...
<?php /**PATH /var/www/vhosts/edustar.academiaenvivo.com/httpdocs/new/edu-pro-new/resources/views/admin/course/courseclass/index.blade.php ENDPATH**/ ?>