<?php $__env->startSection('title', 'All Question Report - Admin'); ?>
    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><?php echo e(__('adminstaticword.Report')); ?> Question</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
              ...
              <tbody>
                ...
                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-primary btn-sm" href="<?php echo e(url('user/question/report/'.$item->id)); ?>">
...
<?php echo $__env->make('admin/layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/edustar.academiaenvivo.com/httpdocs/resources/views/admin/question_report/index.blade.php ENDPATH**/ ?>