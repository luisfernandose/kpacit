                                    ...
                                    <div class="col-lg-4 col-sm-4 col-5">
                                        <div class="course-bought-img">
                                            <?php if($item->preview_image !== NULL && $item->preview_image !== ''): ?>
                                                <a href="<?php echo e(url('course/'.$item->id.'/'.isset($item->slug) ? $item->slug : $item->title)); ?>"><img src="<?php echo e(asset('images/course/'.$item['preview_image'])); ?>" class="img-fluid" alt="blog"></a>
                                            <?php else: ?> 
                                                <a href="<?php echo e(url('course/'.$item->id.'/'.isset($item->slug) ? $item->slug : $item->title)); ?>"><img src="<?php echo e(Avatar::create($item->title)->toBase64()); ?>" class="img-fluid" alt="blog"></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-8 col-7">
                                        <div class="course-name"><a href="<?php echo e(url('course/'.$item->id.'/'.isset($item->slug) ? $item->slug : $item->title)); ?>"><?php echo e(str_limit($item->title, $limit = 35, $end = '...')); ?></a></div>
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/edustar.academiaenvivo.com/httpdocs/new/edu-pro-new/resources/views/front/course_detail.blade.php ENDPATH**/ ?>