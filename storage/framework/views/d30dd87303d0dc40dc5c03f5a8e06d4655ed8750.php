      ...
      <div class="box box-primary">
        ...
        <div class="panel-body">
          <form action="<?php echo e(route('user.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-3">
                <label for="city_id"><?php echo e(__('adminstaticword.Country')); ?>: <sup class="redstar">*</sup> </label>
              ...
              <div class="col-md-3">
                <label for="state_id"><?php echo e(__('adminstaticword.State')); ?>: <sup class="redstar">*</sup> </label>
              ...
              <div class="col-md-3">
                <label for="city_id"><?php echo e(__('adminstaticword.City')); ?>: <sup class="redstar">*</sup> </label>
                <select id="grand" class="form-control js-example-basic-single" name="city_id">
                  
                </select>
              </div>
              <div class="col-md-3"> 
                <label for="pin_code"><?php echo e(__('adminstaticword.Pincode')); ?>:</sup></label>
            ...
            <div class="row">
              <div class="col-md-3">
                <label for="exampleInputSlug"><?php echo e(__('adminstaticword.Image')); ?>: <sup class="redstar">*</sup></label>
                <br>
              ...
              <div class="col-md-3"> 
                ...
                <select class="form-control js-example-basic-single" name="role" required>
                  ...
                  <option value="admin"><?php echo e(__('adminstaticword.Instructor')); ?></option>
                </select>
              </div> 
              <div class="col-md-3">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/edustar.academiaenvivo.com/httpdocs/resources/views/admin/user/adduser.blade.php ENDPATH**/ ?>