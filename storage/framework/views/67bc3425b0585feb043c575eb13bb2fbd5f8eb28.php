...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><?php echo e($class->courses->title); ?></title>
		
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<meta name="viewport" content="initial-scale=1, maximum-scale=1 user-scalable=no" />
		<script src="<?php echo e(asset('js/jquery.min.js')); ?>"></script>
		<link rel="stylesheet" href="<?php echo e(url('content/global.css')); ?>"/>
		<?php
				...
				$(document).ready(function(){
				 	var SITEURL = '<?php echo e(URL::to('')); ?>';
				 	 setInterval(function(){
						...
						var movie_id='<?php echo e($class->id); ?>';
	...
	<body class="player-course-chapter">
		...
		<ul id="courseplaylist" class="display-none">
			<li data-source="courseplaycontent<?php echo e($class->id); ?>" data-playlist-name="<?php echo e($class->coursechapters->chapter_name); ?>" data-thumbnail-path="<?php echo e(url('images/course/'.$class->courses->preview_image)); ?>">
				<p class="minimalDarkCategoriesTitle"><span class="minimialDarkBold">Title: </span><?php echo e($class->coursechapters->chapter_name); ?></p>
				<p class="minimalDarkCategoriesType"><span class="minimialDarkBold">Category: </span><?php echo e($class->courses->category->title); ?></p>
				<p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold">Course: </span><?php echo e(strip_tags($class->courses->title)); ?></p>
			</li>
		</ul>
		<ul id="courseplaycontent<?php echo e($class->id); ?>" class="display-none">
				...
				<li 
					...
					<?php if($class->courses['preview_image'] !== NULL && $class->courses['preview_image'] !== ''): ?>
						data-thumb-source="<?php echo e(url('images/course/'.$class->courses->preview_image)); ?>"
					<?php else: ?>
						data-thumb-source="<?php echo e(Avatar::create($class->courses->title)->toBase64()); ?>"
					<?php endif; ?> 
					...
					<?php if($class->courses['preview_image'] !== NULL && $class->courses['preview_image'] !== ''): ?>
				    	data-poster-source="<?php echo e(url('images/course/'.$class->courses->preview_image)); ?>" 
					<?php else: ?>
						data-poster-source="<?php echo e(url('images/default/course.jpg')); ?>"
					<?php endif; ?>
					...
					?>
						...
						<li <?php if($skipad->ad_video !="no"): ?>
							...
							<?php else: ?>
							data-source="<?php echo e($skipad->ad_url); ?>" <?php endif; ?> data-time-start="<?php echo e($skipad->time); ?>" data-time-to-hold-ads="<?php echo e($skipad->ad_hold); ?>" data-thumbnail-source="<?php echo e(asset('images/course/'.$class->courses->preview_image)); ?>" data-link="<?php echo e($skipad->ad_target); ?>" data-target="_blank"></li>
					    ...
					    <div data-video-short-description="">
		        			 ...
		        			 <p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold">Course: </span><?php echo e($class->courses->title); ?></p>
					    </div>
...
<?php /**PATH /var/www/vhosts/edustar.academiaenvivo.com/httpdocs/resources/views/lightbox.blade.php ENDPATH**/ ?>