    ...
    <div class="col-xs-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <?php echo e(__('adminstaticword.Add')); ?> <?php echo e(__('adminstaticword.State')); ?></h3>
            <div class="panel-heading">
                  <a href=" <?php echo e(url('admin/state')); ?> " class="btn btn-success pull-right owtbtn">< <?php echo e(__('adminstaticword.Back')); ?></a> 
            </div>   
                ...
                <?php echo e(csrf_field()); ?>
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                      <?php echo e(__('adminstaticword.Add')); ?> <?php echo e(__('adminstaticword.State')); ?> <span class="redstar">*</span>
                    </label>
...
<?php echo $__env->make("admin/layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/edustar.academiaenvivo.com/httpdocs/resources/views/admin/country/state/add.blade.php ENDPATH**/ ?>