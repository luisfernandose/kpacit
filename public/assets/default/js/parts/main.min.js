!(function (e) {
    ...
    e(".dropdown-toggle").dropdown(),
        ...
        (window.resetSelect2 = () => {
            jQuery().select2 && e(".select2").select2({ width: "100%" });
        }),
        resetSelect2(),
        (window.loadingSwl = () => {
            Swal.fire({
                html: '<div class="d-flex align-items-center justify-content-center my-50 "><img src="/assets/default/img/loading.gif" width="80" height="80"></div>',
                showCancelButton: !1,
                showConfirmButton: !1,
                width: "30rem",
            });
        }),
        e("body").on("click", ".delete-action", function (t) {
            t.preventDefault(), t.stopPropagation();
            const n = e(this).attr("href");
            var i =
                '<div class="">\n    <p class="">' +
                deleteAlertHint +
        ...
        e("body").on("click", "#swlDelete", function (t) {
            t.preventDefault();
            var n = e(this);
                ...
                e
                    ...
                    .error((e) => {
                        ...
                        e.responseJSON.message &&
                            (t = "<br/>" + e.responseJSON.message),
                            Swal.fire({
                                title: deleteAlertFail,
                                html: deleteAlertFailHint + t,
                                icon: "error",
                            });
                    })
                    .always(() => {
                        n.removeClass("loadingbar primary").prop(
                            "disabled",
                            !1
                        );
                    });
        ...
        (window.serializeObjectByTag = (t) => {
            var n = {},
                i = t.find("input, textarea, select").serializeArray();
            return (
                e.each(i, function () {
                    n[this.name]
        ...
        e(".accordion-row").on("shown.bs.collapse", function () {
            e(this)
                .find(".collapse-chevron-icon")
                .toggleClass("feather-chevron-down feather-chevron-up");
        }),
        e(".accordion-row").on("hidden.bs.collapse", function () {
            e(this)
                .find(".collapse-chevron-icon")
                .toggleClass("feather-chevron-down feather-chevron-up");
        }),
        e("body").on("change", "#userLanguages", function (t) {
