!(function (e) {
        ...
        n.addClass("loadingbar primary").prop("disabled", !0),
            ...
            e
                ...
                .fail((e) => {
                    ...
                    o &&
                        "zoom_jwt_token_invalid" === o.status &&
                        Swal.fire({
                            icon: "error",
                            html:
                                '<h3 class="font-20 text-center text-dark-blue py-25">' +
                        ...
                        o &&
                            o.errors &&
                            Object.keys(o.errors).forEach((e) => {
                                const n = o.errors[e];
                                let s = t.find(".js-ajax-" + e);
    ...
    e("#summernote").length &&
        ...
        e("body").on("click", "#saveCourseOrganization", function (t) {
        ...
        e("body").on("click", "#webinarAddTicket", function (n) {
            n.preventDefault();
            const o = t();
            let s = e("#newTicketForm").html();
            (s = s.replaceAll("record", o)),
                e("#ticketsAccordion").prepend(s),
                resetDatePickers(),
                feather.replace();
        }),
        e("body").on("click", ".js-save-ticket", function (t) {
            t.preventDefault();
            const o = e(this);
            n(o.closest(".ticket-form"), o);
        }),
        e("body").on("click", "#webinarAddSession", function (n) {
            n.preventDefault();
            const o = t();
            let s = e("#newSessionForm").html();
            (s = s.replaceAll("record", o)),
                e("#sessionsAccordion").prepend(s),
                resetDatePickers(),
                feather.replace();
        }),
        e("body").on("click", ".js-save-session", function (t) {
            t.preventDefault();
            const o = e(this);
            n(o.closest(".session-form"), o);
        }),
        e("body").on("click", "#webinarAddFile", function (n) {
            n.preventDefault();
            const o = t();
            let s = e("#newFileForm").html();
            (s = s.replaceAll("record", o)),
                e("#filesAccordion").prepend(s),
                resetDatePickers(),
                feather.replace();
        }),
        e("body").on("click", ".js-save-file", function (t) {
            console.log("pasando js-save-file"), t.preventDefault();
            const o = e(this);
            n(o.closest(".file-form"), o);
        }),
        e("body").on("click", "#AddTextLesson", function (n) {
            n.preventDefault();
            const o = t();
            let s = e("#newTextLessonForm").html();
            (s = (s = (s = (s = s.replaceAll("record", o)).replaceAll(
                "attachments-select2",
                "attachments-select2-" + o
            )).replaceAll(
                "js-content-summernote",
                "js-content-summernote-" + o
            )).replaceAll(
                "js-hidden-content-summernote",
                "js-hidden-content-summernote-" + o
            )),
                e("#text_lessonsAccordion").prepend(s),
                e(".attachments-select2-" + o).select2({
                    multiple: !0,
                    width: "100%",
                }),
                e(".js-content-summernote-" + o).summernote({
                    tabsize: 2,
                    height: 400,
                    callbacks: {
                        onChange: function (t, n) {
                            e(".js-hidden-content-summernote-" + o).val(t);
                        },
                    },
                }),
                feather.replace();
        ...
        e("body").on("click", ".js-save-text_lesson", function (t) {
            t.preventDefault();
            const o = e(this);
            n(o.closest(".text_lesson-form"), o);
        }),
        e(document).ready(function () {
            var t = e("#text_lessonsAccordion .js-content-summernote");
            t.length &&
                t.summernote({
                    tabsize: 2,
                    height: 400,
                ...
                setTimeout(() => {
                    !(function () {
                        ...
                        t.length &&
                            ...
                            e("#text_lessonsAccordion .attachments-select2")
                                .length &&
                                e(
                                    "#text_lessonsAccordion .attachments-select2"
                                ).select2({ multiple: !0, width: "100%" });
                    })();
                }, 1e3);
        }),
        e("body").on("click", "#webinarAddPrerequisites", function (n) {
            n.preventDefault();
            const o = t();
            let s = e("#newPrerequisiteForm").html();
            (s = (s = s.replaceAll("record", o)).replaceAll(
                "prerequisites-select2",
                "prerequisites-select2-" + o
            )),
                e("#prerequisitesAccordion").prepend(s),
                e(".prerequisites-select2-" + o).select2({
        ...
        e("body").on("click", ".js-save-prerequisite", function (t) {
            t.preventDefault();
            const o = e(this);
            n(o.closest(".prerequisite-form"), o);
        }),
        e("body").on("click", "#webinarAddFAQ", function (n) {
            n.preventDefault();
            const o = t();
            let s = e("#newFaqForm").html();
            (s = s.replaceAll("record", o)),
                e("#faqsAccordion").prepend(s),
                feather.replace();
        }),
        e("body").on("click", ".js-save-faq", function (t) {
            t.preventDefault();
            const o = e(this);
            n(o.closest(".faq-form"), o);
        }),
        e("body").on("click", "#webinarAddQuiz", function (n) {
            n.preventDefault();
            const o = t();
            let s = e("#newQuizForm").html();
            (s = s.replaceAll("record", o)),
                e("#quizzesAccordion").prepend(s),
                feather.replace();
        }),
        e("body").on("click", ".js-save-quiz", function (t) {
            t.preventDefault();
            const o = e(this);
            n(o.closest(".quiz-form"), o);
        }),
        e(document).ready(function () {
            function t(t) {
                t.length &&
                    t.sortable({
                        ...
                        update: function (n, o) {
                            ...
                            !(function (t, n) {
                                ...
                                n.target.getAttribute("data-order-table"),
                                s.join(",")
                            );
                        },
                    });
            ...
            var n = e(".draggable-lists"),
                o = e(".draggable-lists2"),
                s = e(".draggable-lists3");
            t(n), o.length && t(o), s.length && t(s);
        }),
        e("body").on("change", ".js-file-storage", function (t) {
            t.preventDefault();
            const n = e(this).attr("value"),
                o = e(this).closest(".file-form");
            this.checked && "online" === n
                ? (o.find(".local-input").addClass("d-none"),
                  o.find(".online-inputs").removeClass("d-none"),
                  o.find(".js-downloadable-file").addClass("d-none"),
                  o.find(".js-downloadable-file input").prop("checked", !1))
                : (o.find(".local-input").removeClass("d-none"),
                  o.find(".online-inputs").addClass("d-none"),
                  o.find(".js-downloadable-file").removeClass("d-none"),
                  o.find(".js-downloadable-file input").prop("checked", !0));
        }),
