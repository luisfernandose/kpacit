(function ($) {
    ...
    $("body").on("click", "#saveCourseOrganization", function (e) {
    ...
    $("body").on("change", "#categories", function (e) {
        ...
        $.get(
            "/panel/filters/get-by-category-id/" + category_id,
            function (result) {
                if (
                    result &&
    ...
    $("body").on("click", "#AddTextLesson", function (e) {
        ...
        add = add.replaceAll(
            "attachments-select2",
            "attachments-select2-" + key
        );
        add = add.replaceAll(
            "js-content-summernote",
            "js-content-summernote-" + key
        );
        add = add.replaceAll(
            "js-hidden-content-summernote",
            "js-hidden-content-summernote-" + key
        );
    ...
    function setSelect2() {
        const selectItem = $(
            "body #prerequisitesAccordion .prerequisites-select2"
        );
    ...
    $(document).ready(function () {
        var summernoteTarget = $(
            "#text_lessonsAccordion .js-content-summernote"
        );
    ...
    $("body").on("click", "#webinarAddPrerequisites", function (e) {
        ...
        add_prerequisite = add_prerequisite.replaceAll(
            "prerequisites-select2",
            "prerequisites-select2-" + key
        );
