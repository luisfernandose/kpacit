                                    ...
                                    <div class="elementor-widget-wrap">
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="seq_absolute_image seq_absolute_image_bdrs ">
                                                    <div class="seq_default_shadow">
                                                        <div class="seq_image_bck" data-image="2022/06/Photo-1.jpg">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="elementor-element elementor-element-105cbced elementor-invisible elementor-widget elementor-widget-sm-absolute-image"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="seq_absolute_image seq_absolute_image_bdrs ">
                                                    <div class="seq_default_shadow">
                                                        <div class="seq_image_bck" data-image="2022/06/Photo-3.jpg">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="elementor-element elementor-element-5b212abb elementor-invisible elementor-widget elementor-widget-sm-absolute-image"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="seq_absolute_image seq_absolute_image_bdrs ">
                                                    <div class="seq_default_shadow">
                                                        <div class="seq_image_bck" data-image="2022/06/Photo-2.jpg">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                        ...
                                                                        <div class="seq_service_block seq_icon_bg">
                                                                            <i class="ti-briefcase sm_icon">
                                                                                <span class="icon_background">
                                                                                    <svg width="88px" height="82px"
                                                                                        viewBox="0 0 88 82" version="1.1"
                                                                    ...
                                                                    <div class="elementor-widget-container">
                                                                        <div class="seq_service_block seq_icon_bg">
                                                                            <i class="ti-bolt sm_icon">
                                                                                <span class="icon_background">
                                                                                    <svg width="88px" height="84px"
                                                                                        viewBox="0 0 88 84" version="1.1"
                                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                                        xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                                        <g stroke="none" stroke-width="1"
                                                                                            fill="none"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-accordion" role="tablist">
                                                    <div class="elementor-accordion-item">
                                                        <h5 id="elementor-tab-title-1521" class="elementor-tab-title"
                                                            data-tab="1" role="tab"
                                                                ...
                                                                <span class="elementor-accordion-icon-opened">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                                                        ...
                                                                        <g clip-path="url(#clip0_157_310)">
                                                                            <path d="M19.0069 10.993L10.9931 19.0069"
                                                                                stroke="#292929" stroke-width="2"
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round"></path>
                                                                            <path d="M10.9931 10.993L19.0069 19.0069"
                                                                                stroke="#292929" stroke-width="2"
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round"></path>
                                                                        </g>
                                                            ...
                                                            <a class="elementor-accordion-title" href="">Lideres de
                                                                Proceso</a>
                                                        </h5>
                                                    ...
                                                    <div class="elementor-accordion-item">
                                                        <h5 id="elementor-tab-title-1522" class="elementor-tab-title"
                                                            data-tab="2" role="tab"
                                                            ...
                                                            <a class="elementor-accordion-title" href="">Gerentes
                                                                de talento humano</a>
                                                        </h5>
                                                    ...
                                                    <div class="elementor-accordion-item">
                                                        <h5 id="elementor-tab-title-1523" class="elementor-tab-title"
                                                            data-tab="3" role="tab"
                                                            ...
                                                            <a class="elementor-accordion-title" href="">Dueños
                                                                de empresa</a>
                                                        </h5>
                                                                ...
                                                                <div class="seq_testimonials_item_desc clearfix">
                                                                    <div class="seq_testimonials_item_title_cont">
                                                                        ...
                                                                        <div class="seq_testimonials_item_title">
                                                                            <div class="seq_testimonials_item_title_name">
                                ...
                                <div class="elementor-column-wrap elementor-element-populated">
                                    <div class="elementor-widget-wrap">
                                        ...
                                        <div class="elementor-element elementor-element-7a2d0d7 elementor-widget elementor-widget-text-editor"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-text-editor elementor-clearfix">
                                                    <div class="wpcf7 js" id="wpcf7-f2063-p156-o1" lang="en-US"
                                                        dir="ltr">
