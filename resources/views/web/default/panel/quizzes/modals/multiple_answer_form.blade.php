        ...
        <div class="col-12 col-md-8">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input id="file{{ !empty($answer) ? $answer->id : '' }}" readonly type="text" name="ajax[answers][{{ !empty($answer) ? $answer->id : 'record' }}][file]" value="{{ !empty($answer) ? $answer->image : '' }}" class="form-control validate-path lfm-input"/>
                </div>
            </div>
        </div>
