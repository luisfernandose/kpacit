            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" readonly name="cover_img" id="cover_img" value="{{ !empty($user) ? str_replace(env('AWS_URL'),'/',$user->cover_img) : old('cover_img') }}" class="form-control validate-path" placeholder="{{ trans('forms.course_cover_size') }}"/>
                    </div>
                </div>
            </div>
        </div>
