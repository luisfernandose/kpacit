                ...
                <div class="row">
                    ...
                    <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <span
                                class="font-16 text-gray font-weight-500">{{ trans('quiz.student_achievements') }}</span>
                        </div>
                    </div>
                                    ...
                                    @foreach ($quizzes as $quiz)
                                        <tr>
                                            <td class="text-left">
                                                ...
                                                <span
                                                    class="d-block mt-5 font-12 text-gray">{{ $quiz->webinar->title }}</span>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <span
                                                    class="text-dark-blue font-weight-500">{{ round($quiz->avg_grade, 2) }}</span>
                                            </td>
                                            <td class="text-dark-blue font-weight-500 align-middle">
                                                {{ count($quiz->certificates) }}</td>
                                            <td class="align-middle">
                                                <span
                                                    class="text-dark-blue font-weight-500">{{ dateTimeFormat($quiz->created_at, 'j F Y') }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
