                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="from" autocomplete="off"
                                        ...
                                        value="{{ request()->get('from', '') }}" aria-describedby="dateInputGroupPrepend" />
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="to" autocomplete="off"
                                        ...
                                        value="{{ request()->get('to', '') }}" aria-describedby="dateInputGroupPrepend" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="webinar_id" class="form-control">
                                    ...
                                    @foreach ($userWebinars as $userWebinar)
                                        <option value="{{ $userWebinar->id }}"
                                            @if (request()->get('webinar_id', '') == $userWebinar->id) selected @endif>{{ $userWebinar->title }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select id="quizFilter" name="quiz_id" class="form-control"
                                            @if (empty(request()->get('quiz_id'))) disabled @endif>
                                            <option value="all">{{ trans('quiz.all_quizzes') }}</option>

                                            @foreach ($userAllQuizzes as $userQuiz)
                                                <option value="{{ $userQuiz->id }}"
                                                    data-webinar-id="{{ $userQuiz->webinar_id }}"
                                                    @if (request()->get('quiz_id', '') == $userQuiz->id) selected @else class="d-none" @endif>
                                                    {{ $userQuiz->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="grade" value="{{ request()->get('grade', '') }}"
                                            class="form-control" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($quizzes as $quiz)
                                        <tr>
                                            <td class="text-left">
                                                <span
                                                    class="d-block text-dark-blue font-weight-500">{{ $quiz->title }}</span>
                                                <span
                                                    class="d-block font-12 text-gray mt-5">{{ $quiz->webinar->title }}</span>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <span
                                                    class="text-dark-blue font-weight-500">{{ $quiz->total_mark }}</span>
                                            </td>
                                            <td class="align-middle">{{ $quiz->result->user_grade }}</td>
                                            <td class="align-middle">
                                                <span
                                                    class="text-dark-blue font-weight-500">{{ dateTimeFormat($quiz->result->created_at, 'j F Y') }}</span>
                                            </td>
                                                    ...
                                                    <div class="btn-group dropdown table-actions">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="/panel/quizzes/results/{{ $quiz->result->id }}/showCertificate"
                                                                target="_blank"
                                                                class="webinar-actions d-block">{{ trans('public.open') }}</a>
                                                            <a href="/panel/quizzes/results/{{ $quiz->result->id }}/downloadCertificate"
                                                                class="webinar-actions d-block mt-10">{{ trans('home.download') }}</a>
                                                        </div>
                                                    </div>
                                                @endif
                                            </td>
