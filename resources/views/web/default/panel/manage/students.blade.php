...
@section('content')
    ...
    <section class="mt-35">
        <div class="row">
            ...
            <div class="col-6">
                <div class="no-result default-no-result d-flex align-items-end justify-content-center flex-column">
                    <div class="d-flex align-items-center flex-column text-center">
                        <a href="/panel/manage/students/new"
                            class="btn btn-sm btn-primary">{{ trans('panel.add_an_student') }}</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr>
                                            <td class="text-left">
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    ...
                                                    <div class=" ml-5">
                                                        ...
                                                        <span
                                                            class="mt-5 d-block font-12 text-{{ $user->status == 'active' ? 'gray' : 'danger' }}">{{ $user->status == 'active' ? trans('public.active') : trans('public.inactive') }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-left">
                                                <div class="">
                                                    <span
                                                        class="d-block text-dark-blue font-weight-500">{{ $user->email }}</span>
                                                    <span class="mt-5 d-block font-12 text-gray">id :
                                                        {{ $user->id }}</span>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <span
                                                    class="text-dark-blue font-weight-500">{{ $user->document_type }}</span>
                                            </td>
                                            <td class="align-middle">
                                                <span
                                                    class="text-dark-blue font-weight-500">{{ $user->document_id }}</span>
                                            </td>
                                            <td class="align-middle">
                                            ...
                                            <td class="align-middle">
                                                <span
                                                    class="text-dark-blue font-weight-500">{{ count($user->getPurchasedCoursesIds()) }}</span>
                                            </td>
                                            <td class="align-middle">
                                                <span
                                                    class="text-dark-blue font-weight-500">{{ count($user->getActiveQuizzesResults()) }}</span>
                                            </td>
                                            <td class="align-middle">
                                                <span
                                                    class="text-dark-blue font-weight-500">{{ count($user->certificates) }}</span>
                                            </td>
                                            <td class="text-dark-blue font-weight-500 align-middle">
                                                {{ dateTimeFormat($user->created_at, 'Y M j | H:i') }}</td>
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="{{ $user->getProfileUrl() }}"
                                                            class="btn-transparent webinar-actions d-block mt-10">{{ trans('public.profile') }}</a>
                                                        <a href="/panel/manage/students/{{ $user->id }}/edit"
                                                            class="btn-transparent webinar-actions d-block mt-10">{{ trans('public.edit') }}</a>
                                                        <a href="/panel/manage/students/{{ $user->id }}/delete"
