                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="day" name="day">
                                        ...
                                        <option value="saturday"
                                            {{ request()->get('day') === 'saturday' ? 'selected' : '' }}>
                ...
                <div class="row">
                    <div class="col-4 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <span
                                class="font-16 text-dark-blue text-gray font-weight-500">{{ trans('panel.open_meetings') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="col-4 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <span
                                class="font-16 text-dark-blue text-gray font-weight-500">{{ trans('panel.total_meetings') }}</span>
                        </div>
                    </div>

                    <div class="col-4 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="/assets/default/img/activity/hours.svg" width="64" height="64"
                                alt="">
                                        ...
                                        <tr>
                                            <td class="text-left">
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    <div class="avatar">
                                                        <img src="{{ $ReserveMeeting->meeting->creator->getAvatar() }}"
                                                            class="img-cover" alt="">
                                                    </div>
                                                    <div class=" ml-5">
                                                        <span
                                                            class="d-block font-weight-500">{{ $ReserveMeeting->meeting->creator->full_name }}</span>
                                                        <span
                                                            class="mt-5 font-12 text-gray d-block">{{ $ReserveMeeting->meeting->creator->email }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <span
                                                    class="font-weight-500">{{ $ReserveMeeting->meetingTime->day_label }}</span>
                                            </td>
                                            <td class="align-middle">
                                            ...
                                            <td class="align-middle">
                                                <span
                                                    class="rounded bg-gray200 py-5 px-15 font-14 font-weight-500">{{ $ReserveMeeting->meetingTime->time }}</span>
                                            </td>
                                            <td class="align-middle font-weight-500">
                                                @if (
                                                    !empty($ReserveMeeting->sale) and
                                                        !empty($ReserveMeeting->sale->total_amount) and
                                                        $ReserveMeeting->sale->total_amount > 0)
                                            ...
                                            <td class="align-middle">
                                                @switch($ReserveMeeting->status)
                                                    ...
                                                    @case(\App\Models\ReserveMeeting::$finished)
                                                        <span
                                                            class="font-weight-500 text-primary">{{ trans('public.finished') }}</span>
                                                    @break
                                                ...
                                                @if ($ReserveMeeting->status != \App\Models\ReserveMeeting::$finished)
                                                    ...
                                                    <div class="btn-group dropdown table-actions">
                                                        ...
                                                        <div class="dropdown-menu menu-lg">
                                                            ...
                                                            <a href="{{ $ReserveMeeting->addToCalendarLink() }}"
                                                                target="_blank"
                                                            ...
                                                            <button type="button" data-id="{{ $ReserveMeeting->id }}"
                                                                class="webinar-actions js-finish-meeting-reserve d-block btn-transparent mt-10 font-weight-normal">{{ trans('panel.finish_meeting') }}</button>
                                                        </div>
                                                    </div>
                                                @endif
                                            </td>
