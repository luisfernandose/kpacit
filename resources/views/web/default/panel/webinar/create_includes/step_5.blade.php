...
<section class="mt-50">
    ...
    <button id="add_new_prerequisite" data-webinar-id="{{ $webinar->id }}" type="button"
        class="btn btn-primary btn-sm mt-15">{{ trans('public.add_prerequisites') }}</button>

    <div class="row mt-10">
        <div class="col-12">

            <div class="accordion-content-wrapper mt-15" id="prerequisitesAccordion" role="tablist"
    ...
    @include(getTemplate() . '.panel.webinar.create_includes.modals.module_new_prerequisites')
</section>
