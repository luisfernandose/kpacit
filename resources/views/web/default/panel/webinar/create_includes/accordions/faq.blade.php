<li data-id="{{ !empty($faq) ? $faq->id : '' }}"
    ...
    <div class="d-flex align-items-center justify-content-between " role="tab"
        ...
        <div class="font-weight-bold text-dark-blue" href="#collapseFaq{{ !empty($faq) ? $faq->id : 'record' }}"
            aria-controls="collapseFaq{{ !empty($faq) ? $faq->id : 'record' }}" data-parent="#faqsAccordion" role="button"
        ...
        <div class="d-flex align-items-center">
            ...
            <i class="collapse-chevron-icon" data-feather="chevron-down" height="20"
                ...
                aria-controls="collapseFaq{{ !empty($faq) ? $faq->id : 'record' }}" data-parent="#faqsAccordion"
    ...
    <div id="collapseFaq{{ !empty($faq) ? $faq->id : 'record' }}"
        ...
        class=" collapse @if (empty($faq)) show @endif" role="tabpanel">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="ajax[{{ !empty($faq) ? $faq->id : 'new' }}][answer]" class="js-ajax-answer form-control"
