    <div class="d-flex align-items-center justify-content-between pt-4" role="tab"
        id="file_{{ !empty($file) ? $file->id : 'record' }}">
        <div class="font-weight-bold text-dark-blue" href="#collapseFile{{ !empty($file) ? $file->id : 'record' }}"
            aria-controls="collapseFile{{ !empty($file) ? $file->id : 'record' }}" data-parent="#filesAccordion"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group pt-15">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" name="ajax[new][storage]" value="local"
                                            ...
                                            class="js-file-storage custom-control-input" checked>
                                        <label class="custom-control-label font-14 cursor-pointer"
                                    ...
                                    <div class="custom-control custom-radio ml-15">
                                        <input type="radio" name="ajax[new][storage]" value="online"
                                            ...
                                            class="js-file-storage custom-control-input">
                                        <label class="custom-control-label font-14 cursor-pointer"
                                ...
                                <div
                                    class="local-input input-group mt-20 @if (!empty($file) and $file->storage == 'online') d-none @endif">
                                    ...
                                    <div class="input-group mt-20">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i data-feather="link" width="18" height="18"
                                                    class="text-white"></i>
                                            </span>
                                        </div>
                    ...
                    <div class="mt-30 d-flex align-items-center">
                        ...
                        @if (empty($file))
                            <button type="button" data-module-id="{{ $module['id'] }}"
                                class="btn btn-sm btn-danger ml-10 @if (isset($edit)) close-file-edit @else close-file @endif">{{ trans('public.close') }}</button>
                        @endif
                    </div>
                </div>
            </form>
