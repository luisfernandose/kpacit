...
<section class="mt-50">
    ...
    <button id="add_new_faq" data-webinar-id="{{ $webinar->id }}" type="button"
        class="btn btn-primary btn-sm mt-15">{{ trans('public.add_faq') }}</button>
    ...
    @include(getTemplate() . '.panel.webinar.create_includes.modals.module_new_faq', ['webinar' => $webinar])
</section>
