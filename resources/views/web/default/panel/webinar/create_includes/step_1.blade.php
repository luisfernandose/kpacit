    ...
    <div class="col-12 col-md-4 mt-15">
        ...
        <div class="form-group mt-15 ">
            ...
            <select name="type" class="custom-select @error('type')  is-invalid @enderror">
                <option value="webinar" @if((!empty($webinar) and $webinar->isWebinar()) or (old('type') == 'webinar')) selected @endif>{{ trans('webinars.webinar') }}</option>
                <option value="course" @if((!empty($webinar) and $webinar->type == 'course') or old('type') == 'course' or (!isset($webinar))) selected @endif>{{ trans('webinars.video_course') }}</option>
