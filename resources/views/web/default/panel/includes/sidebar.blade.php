...
@endif
    ...
    <ul class="sidebar-menu pt-10 @if (!empty($authUser->userGroup)) has-user-group @endif" data-simplebar
        ...
        @if ($authUser->isOrganization())
            ...
            <li class="sidenav-item{{ request()->is('panel/categories*') ? 'sidenav-item-active' : '' }}">
                <a class="d-flex align-items-center" data-toggle="collapse" href="#categoriesCollapse" role="button"
            ...
            <li
                ...
                <a href="/panel/manage/students" class="d-flex align-items-center">
                    <span class="sidenav-item-icon mr-10">
            ...
            <li class="sidenav-item {{ request()->is('panel/reports*') ? 'sidenav-item-active' : '' }}">
                <a class="d-flex align-items-center" data-toggle="collapse" href="#reportsCollapse" role="button"
                ...
                <div class="collapse {{ request()->is('panel/reports*') ? 'show' : '' }}" id="reportsCollapse">
                    <ul class="sidenav-item-collapse">
                        ...
                        <li
                            class="mt-5 {{ request()->is('/panel/reports/users_not_finished_webinars') ? 'active' : '' }}">
                            <a
                                href="/panel/reports/users_not_finished_webinars">{{ trans('panel.users_not_finished_webinars') }}</a>
                        </li>
        ...
        @if ($authUser->isOrganization())
            <li
                class="sidenav-item {{ (request()->is('panel/course-groups') or request()->is('panel/course-groups/*')) ? 'sidenav-item-active' : '' }}">
                <a class="d-flex align-items-center" data-toggle="collapse" href="#courseCollapse" role="button"
                ...
                <div class="collapse {{ (request()->is('panel/course-groups') or request()->is('panel/course-groups/*')) ? 'show' : '' }}"
                    id="courseCollapse">
                    <ul class="sidenav-item-collapse">
