                                    ...
                                    <tr>
                                        <td class="text-left align-middle">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="{{ $result->user->getAvatar() }}" class="img-cover"
                                                        alt="">
                                                </div>
                                                <div class=" ml-5">
                                                    <span class="d-block">{{ $result->user->full_name }}</span>
                                                    <span
                                                        class="mt-5 font-12 text-gray d-block">{{ $result->user->email }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-left align-middle">
                                        ...
                                        <td class="align-middle">{{ dateTimeFormat($result->created_at, 'j F Y H:i') }}
                                        </td>
                                                ...
                                                <div class="dropdown-menu font-weight-normal">
                                                    @if ($result->status != 'waiting')
                                                        <a href="/panel/quizzes/{{ $result->id }}/result"
                                                            class="webinar-actions d-block mt-10">{{ trans('public.view') }}</a>
                                                    @endif

                                                    @if ($result->status == 'waiting')
                                                        <a href="/panel/quizzes/{{ $result->id }}/edit-result"
                                                            class="webinar-actions d-block mt-10">{{ trans('public.review') }}</a>
                                                    @endif

                                                    <a href="/panel/quizzes/results/{{ $result->id }}/delete"
