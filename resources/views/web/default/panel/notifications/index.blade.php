                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-3 mt-10 mt-lg-0 d-flex align-items-start">
                            ...
                            <div class="">
                                ...
                                <span
                                    class="notification-time d-block font-12 text-gray mt-5">{{ dateTimeFormat($notification->created_at, 'Y M j | H:i') }}</span>
                            </div>
                        </div>

                        @if ($notification->title != 'New course shared')
                        ...
                        @else
                            <div class="col-12 col-lg-5 mt-10 mt-lg-0">
                                <span class="font-weight-500 text-gray font-14">{{ trans('public.share_message') }}</span>
                            </div>
                        @endif
