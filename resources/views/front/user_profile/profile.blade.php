	        ...
	        <div class="row">
	            <div class="col-xl-3 col-lg-4">
	                ...
	                <div class="dashboard-items">
	                    <ul>
	                        <li><a href="{{ route('mycourse.show') }}" title="Dashboard"><i class="fa fa-bookmark"></i>{{ __('frontstaticword.MyCourses') }}</a></li>
	                        <li><a href="{{ route('wishlist.show') }}" title="Profile Update"><i class="fa fa-heart"></i>{{ __('frontstaticword.MyWishlist') }}</a></li>
	                        <li><a href="{{ route('purchase.show') }}" title="Followers"><i class="fa fa-history"></i>{{ __('frontstaticword.PurchaseHistory') }}</a></li>
	                        <li><a href="{{route('profile.show',Auth::User()->id)}}" title="Upload Items"><i class="fa fa-user"></i>{{ __('frontstaticword.UserProfile') }}</a></li>
	                        @if(Auth::User()->role == "user")
	                        <li><a href="#" data-toggle="modal" data-target="#myModalinstructor" title="Become An Instructor"><i class="fas fa-chalkboard-teacher"></i>{{ __('frontstaticword.BecomeAnInstructor') }}</a></li>
	                        @endif
	                    </ul>
	                </div>
	            </div>
