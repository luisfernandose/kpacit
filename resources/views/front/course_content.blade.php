        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="class-button txt-rgt">
                    <ul>
                        <li>
                            <a href="{{ route('cirtificate.show', $course->id) }}" class="course_btn"> <i class="fas fa-trophy"></i>&nbsp;Get Certificate</a>
                        </li>
                        <li>
                    ...
                    <div class="video-item hidden-xs">
                        <div class="video-device">
                            ...
                            <div class="video-preview">
                                ...
                                @if(isset($items) && count($course->chapter)>0)
                                
                                @if(count($course->chapter[0]->courseclass)>0 && $course->chapter[0]->courseclass[0]->iframe_url == NULL)
                                ...
                                <div class="learning-questions-block btm-40">
                                    ...
                                    @else
                                        ...
                                        <div class="learning-questions-dtl-block">
                                            <div class="learning-questions-img rgt-20">{{ $question->user->fname }}{{ $question->user->lname }}</div>
                                            ...
                                            <div class="card-header" id="headingFour{{ $announsment->id }}">
                                                <div class="mb-0">
                                                    <button class="btn btn-link" data-toggle="collapse" data-target="#collapseFour{{ $announsment->id }}" aria-expanded="true" aria-controls="collapseFour">
                                                        <div class="learning-questions-img rgt-20">{{ $announsment->user->fname }}{{ $announsment->user->lname  }}
                                                        </div>
                                                        <div class="row">
                                        ...
                                        <div class="card-header" id="headingThree{{ $ques->id }}">
                                            <div class="mb-0">
                                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseThree{{ $ques->id }}" aria-expanded="true" aria-controls="collapseThree">
                                                    <div class="learning-questions-img rgt-10">{{ $ques->user->fname }}{{ $ques->user->lname  }}
                                                    </div>
                                                ...
                                                <div class="answer-block">
                                                    <div class="row no-gutters">
                                                        <div class="col-lg-1 col-2">
                                                            <div class="learning-questions-img-two">{{ $ans->user->fname }}{{ $ans->user->lname  }}
                                                            </div>
                                                        </div>
