                            ...
                            <form action="/admin/categories/trends/{{ !empty($trend) ? $trend->id.'/update' : 'store' }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" readonly name="icon" id="icon" value="{{ !empty($trend) ? str_replace(env('AWS_URL'),'/',$trend->icon) : old('icon') }}" class="form-control validate-path @error('icon') is-invalid @enderror">
