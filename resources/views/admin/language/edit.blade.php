	    ...
	    <div class="col-md-12">
	      <div class="box box-primary">
	        ...
	        <div class="panel-body">
	            ...
	            <form id="demo-form2" method="post" action="{{url('languages')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
	                {{ csrf_field() }}
	            
	              <div class="row">
	                <div class="col-md-5">
	                  <label for="local">{{ __('adminstaticword.Local') }}:<sup class="redstar">*</sup></label>
	                  <input class="form-control" type="text" name="local" value="{{ $language->local }}" placeholder="Please enter language local name" required>
	                </div>
	                <div class="col-md-5">
	                  <label for="name">{{ __('adminstaticword.Name') }}:<sup class="redstar">*</sup></label>
	                  <input type="text" class="form-control" name="name" value="{{ $language->name }}" id="sub_heading" placeholder="Please enter language name eg:English" required>
	                </div>
	                <div class="col-md-2">
