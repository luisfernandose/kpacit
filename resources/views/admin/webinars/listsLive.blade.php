                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td width="120" class="btn-sm">
                                                @can('admin_support_send')
                                                    <a href="/admin/supports/create?user_id={{ $webinar->teacher->id }}"
                                                        target="_blank" class="btn-transparent btn-sm text-primary mt-1"
                                                ...
                                                @can('admin_webinars_delete')
                                                    <a href="/admin/webinars/{{ $webinar->id }}/share" target="_blank"
                                                        class="btn-transparent btn-sm text-primary mt-1" data-toggle="tooltip"
                                                        data-placement="top" title="{{ trans('public.share') }}">
